...
#mhci = pd.read_csv('/Users/yangxiaoyun/Downloads/研究课题/script/replicate/iedb_filtered.csv')

mhci['peptide_length'] = mhci.sequence.apply(f)
mhci = mhci[mhci.peptide_length == pep_length]

pep_net_dict = np.load('../data/bind_pep_net_dict.npy',allow_pickle=True).item()
mhc_net_dict = np.load('../data/bind_mhc_net_dict.npy',allow_pickle = True).item()
mhc_median_network = np.load('../data/bind_mhc_median_network.npy')
...
np.save('../data/immuno_pep_net_dict.npy',pep_net_dict)
np.save('../data/immuno_mhc_net_dict.npy',mhc_net_dict)
np.save('../data/immuno_mhc_median_network.npy',mhc_network)
'''


pep_net_dict = np.load('../data/immuno_pep_net_dict.npy',allow_pickle=True).item()
mhc_net_dict = np.load('../data/immuno_mhc_net_dict.npy',allow_pickle = True).item()
mhc_median_network = np.load('../data/immuno_mhc_median_network.npy')
mhc_median_network =[float(value) for value in mhc_median_network[:4]];mhc_median_network.append('median')
